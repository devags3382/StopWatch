...
class Stopwatch extends Component {
  ...
  componentWillUnmount() {
    // Fix 2: When the setInterval method is used, it is best practice to use clearInterval
  ...
  updateTime = () => {
    this.setState(prevState => ({
      // Fix 5: The key timeElapsedInSeconds in prevState should be used to update
      timeElapsedInSeconds: prevState.timeElapsedInSeconds + 1,
    }))
  }

  onStartTimer = () => {
    // Fix 6: Here to update the timeElapsedInSeconds value for every 1000 milliseconds
    // Fix 7: The id returned by setInterval should be stored in class variable
